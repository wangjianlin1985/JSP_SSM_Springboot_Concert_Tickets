...
<%
    ...
    String userType = (String)request.getAttribute("userType"); //会员级别查询关键字
...
<jsp:include page="../header.jsp"></jsp:include>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="userInfoQueryForm" id="userInfoQueryForm" action="<%=basePath %>UserInfo/frontlist" class="mar_t15" method="post">
			...
			<div class="form-group">
				<label for="userType">会员级别:</label>
				<input type="text" id="userType" name="userType" value="<%=userType %>" class="form-control" placeholder="请输入会员级别">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_userType_edit" class="col-md-3 text-right">会员级别:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="userInfo_userType_edit" name="userInfo.userType" class="form-control" placeholder="请输入会员级别">
			 </div>
		  </div>
		  <div class="form-group">
